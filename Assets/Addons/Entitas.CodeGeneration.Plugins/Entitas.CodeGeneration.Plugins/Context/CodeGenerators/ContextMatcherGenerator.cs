...
";*/
        const string TEMPLATE =
            @"public sealed partial class ${MatcherType}
{
    private Entitas.MatcherInstance<${EntityType}> _matcher;
    
    public ${MatcherType}(Entitas.MatcherInstance<${EntityType}> matcher)
    {
        _matcher = matcher;
    }

    public Entitas.IAllOfMatcher<${EntityType}> AllOf(params int[] indices) {
        return _matcher.AllOf(indices);
    }

    public Entitas.IAllOfMatcher<${EntityType}> AllOf(params Entitas.IMatcher<${EntityType}>[] matchers) {
        return _matcher.AllOf(matchers);
    }

    public Entitas.IAnyOfMatcher<${EntityType}> AnyOf(params int[] indices) {
        return _matcher.AnyOf(indices);
    }

    public Entitas.IAnyOfMatcher<${EntityType}> AnyOf(params Entitas.IMatcher<${EntityType}>[] matchers) {
